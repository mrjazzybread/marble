...
The definition of [`iter_down`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/src/loop.v?ref_type=heads#L62)
...
[`z_step`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/src/iteration.v?ref_type=heads#L495)

+ [`iter_down _i _k s @@ body`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/src/loop.v?ref_type=heads#L70)
  ...
  [`wp_iter_down_body _j j s`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/src/loop.v?ref_type=heads#L130).
  This tactic introduces the current index `_j` and its integer model `j`
  as well as the current state `s`.

+ [`xiter_down _i _k s @@ body`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/src/loop.v?ref_type=heads#L160)
  applies the loop body `body` to every machine
  ...
  At the beginning of the loop body, use the tactic
  [`wp_xiter_down_body _j j s`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/src/loop.v?ref_type=heads#L220).

+ [`uxiter_down _i _k @@ body`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/src/loop.v?ref_type=heads#L248)
  ...
  At the beginning of the loop body, use the tactic
  [`wp_xiter_down_body _j j`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/src/loop.v?ref_type=heads#L307).

+ [`iter_up _i _k s @@ body`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/src/loop.v?ref_type=heads#L342)
  ...
  At the beginning of the loop body, use the tactic
  [`wp_iter_up_body _j j s`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/src/loop.v?ref_type=heads#L407).
  This tactic introduces the current index `_j` and its integer model `j`
  as well as the current state `s`.

+ [`xiter_up _i _k s @@ body`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/src/loop.v?ref_type=heads#L435)
  applies the loop body `body` to every machine integer
  from `_i`, included, up to `_k`, excluded.
  ...
  At the beginning of the loop body, use the tactic
  [`wp_xiter_up_body _j j s`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/src/loop.v?ref_type=heads#L487).

+ [`uxiter_up _i _k @@ body`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/src/loop.v?ref_type=heads#L513)
  ...
  At the beginning of the loop body, use the tactic
  [`wp_xiter_up_body _j j`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/src/loop.v?ref_type=heads#L561).
