...
The judgement [`wp e Q`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/wp.v?ref_type=heads#L103)
...
[return](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/wp.v?ref_type=heads#L123),
...
[`tc`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/tactics.v?ref_type=heads#L86)
and its depth-indexed variants [`tc0` to `tc7`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/tactics.v?ref_type=heads#L77)
...
reasoning rule [`wp_if`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/wp.v?ref_type=heads#L110), so (provided suitable instances of
...
connectives:
[conjunction](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/bool.v?ref_type=heads#L90),
[disjunction](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/bool.v?ref_type=heads#L98),
and
[negation](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/bool.v?ref_type=heads#L106).
...
for example, [`isBool_ltb`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/int.v?ref_type=heads#L404),
...
[`isInt _i i`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/int.v?ref_type=heads#L214).
...
For example,
[addition](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/int.v?ref_type=heads#L301),
[subtraction](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/int.v?ref_type=heads#L314),
and
[multiplication](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/int.v?ref_type=heads#L324)
...
In contrast,
[division](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/int.v?ref_type=heads#L498),
[minimum](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/int.v?ref_type=heads#L447),
[maximum](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/int.v?ref_type=heads#L456),
and the three primitive comparison operators
([`=?`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/int.v?ref_type=heads#L376),
 [`<?`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/int.v?ref_type=heads#L404),
 [`≤?`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/int.v?ref_type=heads#L428))
...
+ [`ITER`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/iteration.v?ref_type=heads#L130) is a very general specification
...
+ [`XITER`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/iteration.v?ref_type=heads#L204) is a variant of `ITER` where the
...
+ [`UXITER`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/iteration.v?ref_type=heads#L229) is a degenerate variant of
...
+ [`ITERI_LIST`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/iteration.v?ref_type=heads#L263) and
  [`ITER_LIST`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/iteration.v?ref_type=heads#L296) are
...
+ [`ITERI_MULTISET`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/iteration.v?ref_type=heads#L326) and
  [`ITER_MULTISET`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/iteration.v?ref_type=heads#L344) are
  specialized versions of `ITER`
...
+ [`ITER_Z`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/iteration.v?ref_type=heads#L532),
  [`XITER_Z`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/iteration.v?ref_type=heads#L543), and
  [`UXITER_Z`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/iteration.v?ref_type=heads#L554)
...
+ The tactics
  [`ITER`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/iteration.v?ref_type=heads#L602),
  [`XITER`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/iteration.v?ref_type=heads#L606), and
  [`UXITER`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/iteration.v?ref_type=heads#L610)
...
+ At the beginning of the loop body, the tactic
  [`wp_body`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/iteration.v?ref_type=heads#L283) should be used.
  ...
  the tactic [`wp_iteri_body`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1655)
  concerns a loop that takes the form of a call to the higher-order function
  [`array.iteri`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1607).
  This tactic should be used at the beginning of the loop body.

+ In the body of an exitable loop, the tactics
  [`wp_continue`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/iteration.v?ref_type=heads#L618) and
  [`wp_break`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/iteration.v?ref_type=heads#L630)
...
The proposition [`isArray a xs`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L116) means
...
([lemma](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L541));
...
* `make _n x` ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L314))
  ...
  use the tactic [`wp_make a`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L387),
...
* `length a` ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L363))
  returns the length of the array `a`.

  To reason about this operation,
  use the tactic [`wp_length n`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L376),
...
* `get a _i` ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L327))
  returns the element stored at index `_i` in the array `a`.

  To reason about this operation,
  use the tactic [`wp_get x`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L379),
  where `x` is the name under you would like this element
  to be known in the proof.
  It is sugar for `wp_op wp_get introducing: x`.

* `set a _i x` ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L339))
  ...
  To reason about this operation,
  use the tactic [`wp_set`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L382).
...
* [`segment_to_list a _i _k`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L421)
  [(specification)](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L456)
  converts the array segment determined by the array `a`
  and the start and end indices `_i` and `_k` into a list.

* [`to_list a`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L442)
  [(specification)](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L480)
  converts the array `a` into a list.

  For this operation,
  we provide [a second specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L501).
  ...
  In a related vein, the lemma [`isArray_iff`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L541)
  establishes that `isArray a xs` is equivalent to `to_list a = xs`.

* [`of_list xs`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L778)
  [(specification)](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L792)
  ...
  The lemma [`to_list_of_list`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L820)
  ...
  [is not true](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L857),
  because an array is defined not only by its content
  but also by its default value.

* [`init _n @@ body`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1670)
  ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1688))
...
* [`list_length xs`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L739)
  ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L747))
...
* [`list_iteri _i xs s @@ body`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L572)
  ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L604))
...
* [`blit a _i b _j _n`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L911)
  [(specification)](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L947)
  ...
  To reason about this operation,
  use the tactic [`wp_blit`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1073).
...
* [`blit' a _i _j _n`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L991)
  [(specification)](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1038)
  copies the array segment determined by the array `a`,
  the start index `_i`, and the length `_n`
...
* [`copy a`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1092)
  [(specification)](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1099)
  creates a fresh copy of the array `a`,
  that is, a new array whose content
  is the same as the content of the array `a`.

* [`sub a _i _n`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1122)
  [(specification)](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1128)
...
* [`append a b`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1156)
  [(specification)](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1168)
  creates a new array whose content is the concatenation
  of the content of the arrays `a` and `b`.

* [`fill a _i _n x`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1198)
  [(specification)](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1219)
  ...
  To reason about this operation,
  use the tactic [`wp_fill`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1239).
  This tactic intentionally clears the previous array `a`
  and names the new array `a` in the proof.
  It behaves like `wp_op wp_fill shadowing: a`.

* [`find_index f a`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1259)
  [(specification)](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1309)
...
* [`exist f a`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1382)
  [(specification)](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1395)
  searches the array `a`, from left to right,
  for an element `x` such that `f x` is true.
  Its result is `true` if such an element exists
  and `false` otherwise.

* [`for_all f a`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1424)
  [(specification)](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1437)
...
* [`equal eq a b`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1469)
  ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1513))
  ...
  A [simpler specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1513) is given
  in the case where the function `eq` is an equality test.

* [`segment_iteri a _i _k s @@ body`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1588)
  ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1613))
  ...
  At the beginning of the loop body, use the tactic
  [`wp_segment_iteri_body _j j x s`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1650).

* [`iteri a s @@ body`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1607)
  ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1632))
  ...
  `wp_op wp_iteri`.
  At the beginning of the loop body, use the tactic
  [`wp_iteri_body _j j x s`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1655).

### Tactics

The tactic [`isArray`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L397) is applicable when the
...
The tactic [`arrays`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L159) looks for every hypothesis of the
...
[`blit`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L911), which expects two arrays as
...
Instead, use [`blit'`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L991), a variant of `blit`
