...
We provide the notation [`do x ← e1 ; e2`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/wp.v?ref_type=heads#L49)
...
We also provide the notation [`f @@ x`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/wp.v?ref_type=heads#L39)
...
[`IFC e0 THEN e1 ELSE e2`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/equations.v?ref_type=heads#L28)
and
[`IF e0 THEN e1 ELSE e2`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/equations.v?ref_type=heads#L31).
...
The judgement [`wp e Q`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/wp.v?ref_type=heads#L127)
means that the expression `e` has the postcondition `Q`:
that is, the result of `e` satisfies the property `Q`.
...
[return](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/wp.v?ref_type=heads#L147),
[sequencing](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/wp.v?ref_type=heads#L159),
[conditional](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/wp.v?ref_type=heads#L134),
and
[consequence](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/wp.v?ref_type=heads#L241).

To apply these reasoning rules, we offer a number of tactics.

The tactic [`wp_ret`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/wp.v?ref_type=heads#L383) should be used when the goal is
...
[`wp_ret_hook`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/wp.v?ref_type=heads#L378), which can be customized.

The tactic [`wp_if`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/wp.v?ref_type=heads#L396) should be used when the goal is
...
The tactic [`wp_op`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/wp.v?ref_type=heads#L552) is the main workhorse of
...
[`wp_precondition_primary_hook`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/wp.v?ref_type=heads#L475)
and
[`wp_precondition_secondary_hook`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/wp.v?ref_type=heads#L479),
...
one typically uses either [`wp_intro x`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/wp.v?ref_type=heads#L428)
or
[`wp_shadow x`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/wp.v?ref_type=heads#L447).

[`wp_intro x`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/wp.v?ref_type=heads#L428)
...
and uses the tactic [`wp_intro_hook`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/wp.v?ref_type=heads#L419),
...
(`tactics.v`)[../theories/tactics.v]. In particular, the tactic
[`tc`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/tactics.v?ref_type=heads#L92)
and its depth-indexed variants [`tc0` to `tc7`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/tactics.v?ref_type=heads#L83)
...
For this purpose,
we define the type class [`isBool b P Q`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/bool.v?ref_type=heads#L38).
...
reasoning rule [`wp_if`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/wp.v?ref_type=heads#L134), so (provided suitable instances of
...
connectives:
[conjunction](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/bool.v?ref_type=heads#L94),
[disjunction](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/bool.v?ref_type=heads#L102),
and
[negation](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/bool.v?ref_type=heads#L110).
...
for example, [`isBool_ltb`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/int.v?ref_type=heads#L419),
...
[`isInt _i i`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/int.v?ref_type=heads#L229).
...
For example,
[addition](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/int.v?ref_type=heads#L316),
[subtraction](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/int.v?ref_type=heads#L329),
and
[multiplication](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/int.v?ref_type=heads#L339)
...
In contrast,
[division](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/int.v?ref_type=heads#L513),
[minimum](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/int.v?ref_type=heads#L462),
[maximum](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/int.v?ref_type=heads#L471),
and the three primitive comparison operators
([`=?`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/int.v?ref_type=heads#L391),
 [`<?`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/int.v?ref_type=heads#L419),
 [`≤?`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/int.v?ref_type=heads#L443))
...
+ [`ITER`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/iteration.v?ref_type=heads#L138) is a very general specification
...
+ [`XITER`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/iteration.v?ref_type=heads#L214) is a variant of `ITER` where the
...
+ [`UXITER`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/iteration.v?ref_type=heads#L240) is a degenerate variant of
...
+ [`ITERI_LIST`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/iteration.v?ref_type=heads#L282) and
  [`ITER_LIST`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/iteration.v?ref_type=heads#L317) are
...
+ [`ITERI_MULTISET`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/iteration.v?ref_type=heads#L348) and
  [`ITER_MULTISET`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/iteration.v?ref_type=heads#L369) are
  specialized versions of `ITER`
...
+ [`ITER_Z`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/iteration.v?ref_type=heads#L621),
  [`XITER_Z`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/iteration.v?ref_type=heads#L633), and
  [`UXITER_Z`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/iteration.v?ref_type=heads#L645)
...
or array elements
(as in [`array.iteri`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1698)).

We provide several tactics that help work with these specifications:

+ The tactics
  [`ITER`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/iteration.v?ref_type=heads#L693),
  [`XITER`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/iteration.v?ref_type=heads#L697), and
  [`UXITER`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/iteration.v?ref_type=heads#L701)
...
+ At the beginning of the loop body, the tactic
  [`wp_body`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/iteration.v?ref_type=heads#L304) should be used.
  ...
  the tactic [`wp_iteri_body`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1721)
  concerns a loop that takes the form of a call to the higher-order function
  [`array.iteri`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1673).
  This tactic should be used at the beginning of the loop body.

+ In the body of an exitable loop, the tactics
  [`wp_continue`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/iteration.v?ref_type=heads#L709) and
  [`wp_break`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/iteration.v?ref_type=heads#L721)
...
[`z_step`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/iteration.v?ref_type=heads#L596)
...
The proposition [`isArray a xs`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L117) means
...
([lemma](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L542));
...
* `make _n x` ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L315))
  ...
  use the tactic [`wp_make a`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L388),
...
* `length a` ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L364))
  returns the length of the array `a`.

  To reason about this operation,
  use the tactic [`wp_length n`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L377),
...
* `get a _i` ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L328))
  returns the element stored at index `_i` in the array `a`.

  To reason about this operation,
  use the tactic [`wp_get x`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L380),
  where `x` is the name under you would like this element
  to be known in the proof.
  It is sugar for `wp_op wp_get introducing: x`.

* `set a _i x` ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L340))
  ...
  To reason about this operation,
  use the tactic [`wp_set`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L383).
...
* [`segment_to_list a _i _k`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L422)
  [(specification)](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L457)
  converts the array segment determined by the array `a`
  and the start and end indices `_i` and `_k` into a list.

* [`to_list a`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L443)
  [(specification)](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L481)
  converts the array `a` into a list.

  For this operation,
  we provide [a second specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L502).
  ...
  In a related vein, the lemma [`isArray_iff`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L542)
  establishes that `isArray a xs` is equivalent to `to_list a = xs`.

* [`of_list xs`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L844)
  [(specification)](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L858)
  ...
  The lemma [`to_list_of_list`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L886)
  ...
  [is not true](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L923),
  because an array is defined not only by its content
  but also by its default value.

* [`init _n @@ body`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1736)
  ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1754))
...
* [`list_length xs`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L805)
  ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L813))
...
* [`list_iteri _i xs s @@ body`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L638)
  ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L670))
...
* [`blit a _i b _j _n`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L977)
  [(specification)](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1013)
  ...
  To reason about this operation,
  use the tactic [`wp_blit`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1139).
...
* [`blit' a _i _j _n`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1057)
  [(specification)](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1104)
  copies the array segment determined by the array `a`,
  the start index `_i`, and the length `_n`
...
* [`copy a`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1158)
  [(specification)](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1165)
  creates a fresh copy of the array `a`,
  that is, a new array whose content
  is the same as the content of the array `a`.

* [`sub a _i _n`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1188)
  [(specification)](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1194)
...
* [`append a b`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1222)
  [(specification)](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1234)
  creates a new array whose content is the concatenation
  of the content of the arrays `a` and `b`.

* [`fill a _i _n x`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1264)
  [(specification)](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1285)
  ...
  To reason about this operation,
  use the tactic [`wp_fill`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1305).
  This tactic intentionally clears the previous array `a`
  and names the new array `a` in the proof.
  It behaves like `wp_op wp_fill shadowing: a`.

* [`find_index f a`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1325)
  [(specification)](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1375)
  searches the array `a`, from left to right,
  for an element `x` such that `f x` is true.
  Its result has type [`outcome int`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/iteration.v?ref_type=heads#L51).

* [`exist f a`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1448)
  [(specification)](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1461)
  searches the array `a`, from left to right,
  for an element `x` such that `f x` is true.
  Its result is `true` if such an element exists
  and `false` otherwise.

* [`for_all f a`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1490)
  [(specification)](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1503)
...
* [`equal eq a b`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1535)
  ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1579))
  ...
  A [simpler specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1579) is given
  in the case where the function `eq` is an equality test.

* [`segment_iteri a _i _k s @@ body`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1654)
  ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1679))
  ...
  At the beginning of the loop body, use the tactic
  [`wp_segment_iteri_body _j j x s`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1716).

* [`iteri a s @@ body`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1673)
  ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1698))
  ...
  `wp_op wp_iteri`.
  At the beginning of the loop body, use the tactic
  [`wp_iteri_body _j j x s`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1721).

### Tactics

The tactic [`isArray`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L398) is applicable when the
...
The tactic [`arrays`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L160) looks for every hypothesis of the
...
The file [`sort.v`](../theories/sort.v) contains algorithms that sort arrays and
merge sorted arrays.

The desired ordering, and comparison function, are provided in an implicit
way, via type class instances. The type class [`Leb`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/compare.v?ref_type=heads#L33)
provides a two-way comparison function; the type class
[`LebSpec`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/compare.v?ref_type=heads#L90) provides a proof that this function is
correct with respect to a certain pre-order `≤`. It is up to you, as a user,
to provide suitable instances of these type classes.

+ [`isortto`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/sort.v?ref_type=heads#L663) and
  [`isortto'`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/sort.v?ref_type=heads#L888) are
...
+ [`sort_seg a _i _n`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/sort.v?ref_type=heads#L2488)
  ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/sort.v?ref_type=heads#L2496))
  ...
  [a simpler specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/sort.v?ref_type=heads#L2700)
  can be used.

  To reason about this operation, use the tactic
  [`wp_sort_seg`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/sort.v?ref_type=heads#L2775).
  It intentionally shadows the array `a`.
  It uses the simpler specification of `sort_seg`, without stability.

+ [`sort a`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/sort.v?ref_type=heads#L2523)
  ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/sort.v?ref_type=heads#L2551))
  is a merge sort algorithm.
  ...
  according to the pre-order `≤` then they are not exchanged.
  When stability is not useful,
  [a simpler specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/sort.v?ref_type=heads#L2728)
  can be used.

  To reason about this operation, use the tactic
  [`wp_sort`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/sort.v?ref_type=heads#L2781).
  It intentionally shadows the array `a`.
  It uses the simpler specification of `sort`, without stability.

+ [`merge a b`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/sort.v?ref_type=heads#L2572)
  ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/sort.v?ref_type=heads#L2585))
  ...
  according to the pre-order `≤` then they are not exchanged.
  When stability is not useful,
  [a simplified specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/sort.v?ref_type=heads#L2751)
  can be used.
...
file [`sorting.v`](../theories/sorting.v). They are not intended to be used by end
...
The proposition [`isVector v xs`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/vector.v?ref_type=heads#L56)
means that the vector `v` stores the sequence `xs`.

### Operations

+ [`create()`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/vector.v?ref_type=heads#L194)
  ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/vector.v?ref_type=heads#L201))
  creates a new empty vector.

+ [`length v`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/vector.v?ref_type=heads#L212)
  ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/vector.v?ref_type=heads#L216))
  returns the length of the vector `v`.

+ [`get v _i`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/vector.v?ref_type=heads#L227)
  ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/vector.v?ref_type=heads#L231))
  returns the element found at index `_i` in the vector `v`.

+ [`set v _i x`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/vector.v?ref_type=heads#L240)
  ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/vector.v?ref_type=heads#L245))
...
+ [`pop v`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/vector.v?ref_type=heads#L265)
  ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/vector.v?ref_type=heads#L275);
   [alternate specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/vector.v?ref_type=heads#L292))
...
+ [`push v x`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/vector.v?ref_type=heads#L414)
  ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/vector.v?ref_type=heads#L429))
...
+ [`reserve v`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/vector.v?ref_type=heads#L465)
  ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/vector.v?ref_type=heads#L479))
...
+ [`segment_iteri v _i _k s @@ body`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/vector.v?ref_type=heads#L512)
  ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/vector.v?ref_type=heads#L522))
...
+ [`iteri v s @@ body`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/vector.v?ref_type=heads#L516)
  ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/vector.v?ref_type=heads#L540))
...
+ [`steal_array a`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/vector.v?ref_type=heads#L566)
  ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/vector.v?ref_type=heads#L576))
  and
  [`of_array a`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/vector.v?ref_type=heads#L570)
  ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/vector.v?ref_type=heads#L588))
...
+ [`of_list xs`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/vector.v?ref_type=heads#L641)
  ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/vector.v?ref_type=heads#L647))
  converts a list to a vector.

### The Unboxed Vector API

The [unboxed-vector API](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/vector.v?ref_type=heads#L663)
...
see the file [`pqueue.v`](../theories/pqueue.v),
where the function [`move_up`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/pqueue.v?ref_type=heads#L600)
uses direct array accesses,
and the [proof](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/pqueue.v?ref_type=heads#L689) of this function
uses the unboxed-vector API.

### Tactics

The tactic [`isVector`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/vector.v?ref_type=heads#L158) is applicable when the
...
The tactic [`vectors`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/vector.v?ref_type=heads#L131) looks for every hypothesis of
...
[`Leb`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/compare.v?ref_type=heads#L33) provides a two-way comparison function; the type
class [`LebSpec`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/compare.v?ref_type=heads#L90) provides a proof that this function
is correct. It is up to you, as a user, to provide suitable instances of these
type classes.

The proposition [`isQueue R v xs`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/vector.v?ref_type=heads#L56)
...
+ [`create()`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/pqueue.v?ref_type=heads#L570)
  ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/pqueue.v?ref_type=heads#L573))
  creates a new empty queue.

+ [`insert q x`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/pqueue.v?ref_type=heads#L624)
  ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/pqueue.v?ref_type=heads#L776))
  inserts the element `x` into the queue `q`.
  An updated queue is returned.

+ [`extract_nonempty q`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/pqueue.v?ref_type=heads#L875)
  ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/pqueue.v?ref_type=heads#L1030))
  extracts a minimal element out of a nonempty queue.
  A pair of the extracted element
  and an updated queue is returned.

+ [`extract q`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/pqueue.v?ref_type=heads#L895)
  ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/pqueue.v?ref_type=heads#L1070))
...
+ [`iter q s @@ body`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/pqueue.v?ref_type=heads#L1103)
  ([specification](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/pqueue.v?ref_type=heads#L1107))
  iterates over the elements of the queue `q`
  in an unspecified order.

### Tactics

The tactic [`isQueue`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/pqueue.v?ref_type=heads#L1142) is applicable when the goal has
...
The tactic [`queues`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/pqueue.v?ref_type=heads#L546) looks for every hypothesis of
the form `isQueue R q xs` and introduces the fact `0 ≤ len xs ≤ max_array_length`.
It also introduces the fact `unsigned max_array_length`.
It is often useful to invoke this tactic once at the beginning of a proof.
...
This library makes heavy use of Rocq's
[primitive arrays](https://rocq-prover.org/doc/master/refman/language/core/primitive.html#primitive-arrays).

This data structure is persistent: this means that updating an array *appears*
to create a new array, and does not destroy or modify the original array,
which can still be accessed and still appears to contain the same data. In
other words, updating an array creates a new *version* of this array. Earlier
versions can still be accessed, that is, read or updated.

In principle, this sounds great: all versions are available at all times. In
reality, however, only the latest version of an array can be *efficiently*
accessed. A read or write access to the latest version has time complexity
*O(1)*: it takes a constant amount of time. A read or write access to an old
version requires first restoring this old version, that is, making it current
again. This involves undoing all of the updates that have taken place since
that version was current. This takes time *O(d)* where *d* is the distance
between the two versions, that is, the number of updates that have taken place
between them. In a particularly bad scenario, if a program keeps accessing
*two* versions of an array in an alternating manner, then *every* access will
cost *O(d)* where *d* is the distance between these versions.

In summary, the bottom line is: even though Rocq's arrays are persistent, in
order to achieve good efficiency, they should be used in the same way as if
they were mutable. That is, **only the latest version of each array should be
used**.

To avoid using an old version by mistake, we suggest relying on shadowing.
When updating an array named `a`, one intentionally names the updated array
`a`. Thereafter, the name `a` refers to the updated array. The previous array
becomes inaccessible, simply because it cannot be named any more. Our tactics
also encourage this style: the tactic `wp_op <lemma> shadowing: a` clears the
previous variable `a` before introducing a new variable named `a`.

This discipline concerns not just arrays, but also all data structures based
on arrays, including vectors and priority queues. Even though these data
structures are technically persistent, they should be intuitively considered
mutable. One should obey the rule: **only the latest version of each
array-based data structure should be used**.

Although this discipline is usually easy to obey, in some situations, one must
pay particular attention.

One situation to look out for is a call to a function that expects *several
arrays* (or array-based data structures) as parameters. An example is
[`blit`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L977), which expects two arrays as
arguments. If one passes the same array twice, as in `blit a _i a _j _n`, then
`blit` will alternate between reading the array `a` and writing an array `b`
that is a descendant of the array `a`. As a result, the cost of such a call to
`blit` will be quadratic in `_n`, instead of linear, as one would expect. To
avoid this problem, one must *not* pass the same array twice to `blit`.
Instead, use [`blit'`](https://gitlab.inria.fr/fpottier/marble/-/blob/main/theories/array.v?ref_type=heads#L1057), a variant of `blit`
which expects only one array as an argument, and uses this array both as the
source array and the destination array.

Another pattern that must be avoided is updating an array while iterating over
this array. That is,, in a loop of the form `array.iteri a s @@ body`, the
function `body` must not update (write) the array `a`. In other words, the
state `s` should not contain the array `a` itself: in particular, a call of
the form `array.iteri a a @@ body` must be avoided.

In summary, an array, or an array-based data structure, should be used *in a
linear way*. It should be known by only one name. This name should always
refer to the latest version of this data structure. This name should never be
duplicated, that is, passed twice as an argument to a function.

As an exception to this general rule, it is safe to pass an array twice to a
function *if* this function accesses its arguments only for reading. For
example, the call `array.append a a`, which reads the array `a` twice, is
safe, as it does not update `a`.

Is there a way of mechanically checking that the linear use discipline is
respected? Inside Rocq, no. However, via [extraction from Rocq to
OCaml](#extraction-to-ocaml), there is a way. If the extracted code is linked
with [defensive arrays](../extracted/DefensiveArray.ml), then, at runtime, an
access to an outdated array will cause a runtime error. Thus, *testing* can
help verify that the linear use discipline is respected.
